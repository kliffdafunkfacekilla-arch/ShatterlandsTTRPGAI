# AI-TTRPG/monolith/modules/character_pkg/database.py
import os
...
# Path(__file__).resolve() is this file: .../monolith/modules/character_pkg/database.py
# .parents[0] = character_pkg
# .parents[1] = modules
# .parents[2] = monolith
# .parents[3] = AI-TTRPG
# .parents[4] = project root (where characters.db is)
